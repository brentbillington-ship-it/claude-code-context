...
| `playbook/agents/proposal-legal-reviewer.md` | **ACTIVE** | 2026-05-15 | 2026-05-15 | Legal review of BW proposals vs executed NDA/MSA (IP/work-product overreach, missing carve-outs, governing-law, dispute language). Drafted for Gala Holdings v1 proposal review; reusable for any BW client. References `project_gala_ownership_clause.md` memory for canonical Ownership clause shape | BW stops sending proposals |
| `playbook/agents/proposal-contract-mgmt.md` | **ACTIVE** | 2026-05-15 | 2026-05-15 | Standard-clause completeness check for BW proposals (termination, dispute resolution, payment terms, warranty/LoL, force majeure, milestones, notices, governing law, validity) | BW stops sending proposals |
| `playbook/agents/proposal-pricing-reviewer.md` | **ACTIVE** | 2026-05-15 | 2026-05-15 | Pricing review of BW proposals (math, milestone economics, add-on ranges, competitive anchoring vs. engagement-specific research). Pairs with engagement-specific pricing agents | BW stops sending proposals |
| `playbook/agents/proposal-scope-qa.md` | **ACTIVE** | 2026-05-15 | 2026-05-15 | Scope QA of BW proposals: discovery + buyer-confirmation cross-reference; hard-boundary drift detection; ambiguity flagging | BW stops sending proposals |
